...
for index,(angle,distance) in enumerate(distance_table):
    ...
    # if angle not in {937}:
    #     continue
    image_i = cv2.imread(input_path+folder+"/"+str(angle)+"/l.jpg")
